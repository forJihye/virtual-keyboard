...
declare class DeleteKeyButton extends KeyFunction {
  type: KeyButtonType;
  run(keyboard: Keyboard, cb: (data: any) => void): void;
}
declare class BackspaceKeyButton extends KeyFunction {
  type: KeyButtonType;
  run(keyboard: Keyboard, cb: (data: any) => void): void;
}
declare class GotoKeyButton extends KeyFunction {
  type: KeyButtonType;
  options: number;
  run(keyboard: Keyboard, cb: (data: any) => void): void;
}
